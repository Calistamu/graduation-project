...
问题：
1.我的论文题目应该是在老师给的毕设题目及要求的基础上具体化出一个题目，对吗？
2.以防我忘记学过什么，目前.md的内容过于冗长和啰嗦，之后会精简，只是想让老师看看我的方向对不对，是对的吗？
3.写在ppt上，除了非必要，我准备用词组的方式展现我要讲的内容，其余口述，答辩的时候哪些内容老师认为必不可少？
4.论文摘自网络也可以吗，就是页面上的时间吗？